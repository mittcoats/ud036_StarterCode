...
hidden_figures = media.Movie("Hidden Figures",
                             "A group of black women help NASA lunar missions",
...
lord_of_the_rings = media.Movie("Lord of the Rings",
                                "A young hobit must destroy a powerful weapon",
...
imitation_game = media.Movie("Imitation Game",
                             "A mathematician breaks the German Enigma",
...
harry_potter = media.Movie("Harry Potter",
                           "A boy is chosen to bring down the dark lord",
...
caddy_shack = media.Movie("Caddy Shack",
                          "A greens keeper spoofs the country club lifestyle",
...
constant_gardener = media.Movie("The Constant Gardener",
                                "A man navigates crime rings in Kenya",
